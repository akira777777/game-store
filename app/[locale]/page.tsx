...
export default async function HomePage({
  ...
  const newGames = mockGames.slice().sort((a, b) => b.createdAt.getTime() - a.createdAt.getTime())
  const discountedGames = mockGames.filter(game => game.discountPrice !== null && game.inStock)
