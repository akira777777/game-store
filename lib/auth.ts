...
if (!authSecret) {
  ...
  // In production, this will log a warning but the app might fail at runtime if not set
  console.warn(
    '⚠️  Warning: AUTH_SECRET or NEXTAUTH_SECRET not set. Using fallback secret. ' +
