  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
      <div className="relative animate-card-reveal">
        ...
        <div className="absolute -inset-4">
          {[...Array(12)].map((_, i) => (
            <div
              ...
              style={{
                left: `${50 + Math.cos((i * Math.PI * 2) / 12) * 200}%`,
                top: `${50 + Math.sin((i * Math.PI * 2) / 12) * 200}%`,
        ...
        {/* Main card */}
        <div className="relative bg-gradient-to-br from-white via-pink-50 to-purple-50 rounded-3xl shadow-2xl p-12 md:p-16 max-w-2xl mx-4 border-4 border-yellow-300">
          {/* Decorative elements */}
          ...
          <div className="text-center space-y-6">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent animate-fade-in">
              С Днем Рождения,
            </h1>
            <h2 className="text-6xl md:text-8xl font-extrabold bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent animate-fade-in" style={{ animationDelay: "0.2s" }}>
              Татьяна!
            </h2>
            <div className="pt-4 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              ...
              <p className="text-xl md:text-2xl text-gray-700 font-medium mt-2">
                радостью и счастьем! ✨
              </p>
            </div>
          </div>
